...
export interface SaasSolutionCategoryResponse extends ApiResponse<SaasSolutionCategory> {
}
export interface SaasSolutionCategoriesResponse extends ApiResponse<SaasSolutionCategory[]> {
}
